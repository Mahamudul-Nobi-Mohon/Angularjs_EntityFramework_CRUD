...
namespace AngularCRUD_EntityFramework.Controllers
{
    public class StudentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentId,Name,Address,Email,DepartmentId")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentId,Name,Address,Email,DepartmentId")] Student student)
        {
            if (ModelState.IsValid)
            {
